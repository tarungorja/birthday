...
export default function FinanceMonitoring() {
    ...
    const seriesSeven = [
        {
            data: [
                10, 12, 18, 25, 15, 30, 40, 10, 20, 12, 16, 60, 20, 15, 10, 60,
                50, 40, 80, 100, 30, 40, 10, 20, 12, 16, 60, 20, 15, 60, 20, 15,
                10, 60, 50, 40, 30, 40, 10, 20, 16, 60, 20, 15, 60, 20, 15, 10,
                60, 50, 40, 30, 40, 10, 20,
            ],
        },
        {
            data: [
                -10, -12, -18, -25, -15, -30, -40, -10, -20, -12, -16, -60, -20,
                -15, -10, -60, -50, -40, -80, -40, -30, -40, -10, -20, -12, -16,
                -60, -20, -15, -60, -20, -15, -10, -60, -50, -40, -30, -40, -10,
                -20, -40, -10, -20, -12, -16, -60, -20, -15, -60, -20, -15, -10,
                -60, -50, -40,
            ],
        },
    ];
                    ...
                    <Col xl="9">
                        <Card className="card-one">
                            <Card.Body className="overflow-hidden px-0 pb-3">
                                ...
                                <Nav
                                    as="nav"
                                    className="nav-finance-one p-3 p-xl-4"
                                >
                                ...
                                <Card className="card-one">
                                    <Card.Body className="overflow-hidden">
                                        ...
                                        <p className="fs-xs text-secondary mb-0 lh-4">
                                            The gross profit you make on each
                                            dollar of sales.
                                        </p>
                            ...
                            <Col sm="6" xl="12">
                                <Card className="card-one">
                                    <Card.Body>
                                        ...
                                        <p className="fs-xs text-secondary mb-0 lh-4">
                                            Measures your business at generating
                                            profit sales.
                                        </p>
                        ...
                        <Card className="card-one">
                            <Card.Body>
                                ...
                                <p className="fs-sm text-secondary mb-0">
                                    Measures your Accounts Receivable / Current
                                    Liabilities
                                </p>
                            </Card.Body>
                        </Card>
                        ...
                        <Card className="card-one">
                            ...
                            <Card.Body className="pt-0">
                                <p className="fs-sm text-secondary mb-4">
                                    ...
                                    It is calculated by finding the profit as a
                                    ...
                                    <Col md="6">
                                        <div className="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p className="fs-sm text-secondary mb-0">
                                                    Fixed expenses are generally
                                                    fixed in both amount and
                                                    interval.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <Col sm="6" xl="3">
                                        <div className="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p className="fs-sm text-secondary mb-0">
                                                    Money owed by a business to
                                                    its suppliers shown as a
                                                    liability.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <Col sm="6" xl="3">
                                        <div className="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p className="fs-sm text-secondary mb-0">
                                                    Measures whether a firm has
                                                    enough resources to meet its
