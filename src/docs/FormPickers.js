            ...
            <div className="main main-docs">
                <Container>
                    ...
                    <p className="main-title-text">
                        The date and color picker is tied to a standard form
                        input field. Focus on the input (click, or use the tab
                    ...
                    <p>
                        Display the datepicker embedded in the page instead of
                        in an overlay.
                    </p>
                    ...
                    <p>
                        Choose a date, click elsewhere on the page (blur the
                        input), or hit the Esc key to close. If a date is
...
/>`}</code>
                    ...
                    <p>
                        A Collection of Color Pickers from Sketch, Photoshop,
                        Chrome, Github, Twitter, Material Design & more. To
