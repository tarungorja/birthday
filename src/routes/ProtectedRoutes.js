...
//MyComponents
import HealthViewPage from '../myComponents/views/HealthViewPage';
import InfiniteScroll from '../myComponents/InfiniteScroll';
import HealthTracker from '../myComponents/Trackers/HealthTracker';
...
const protectedRoutes = [
    ...
    { path: '/tracker/health', element: <HealthTracker /> },
    {
        path: '/health-feed/health-view-page/:batteryId',

        element: <HealthViewPage />,
    },
    {
        path: '/health-feed/health-view-page',
